...
public class Camera2Activity extends AppCompatActivity {
    ...
    private void createCameraPreview() {
        try {
            ...
            Log.e("Camera2Activity", "OptimalSize width: " + mPreviewSize.getWidth() + " height: " + mPreviewSize.getHeight());
...
//                    Toast.makeText(Camera2Activity.this, "Camera configuration change", Toast.LENGTH_SHORT).show();
                }
            }, null);
        } catch (CameraAccessException e) {
            e.printStackTrace();
